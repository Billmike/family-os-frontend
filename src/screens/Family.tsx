...
export default function FamilyScreen({
  ...
  const canInvite =
    currentMemberRole === "admin" || currentMemberRole === "parent";
    ...
    <div style={{ minHeight: "100%", paddingBottom: 40 }}>
        ...
        <div style={{ margin: "0 16px 20px" }}>
          ...
          >
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <p style={{ fontSize: 12, color: t.textTer }}>
      ...
      {confirm?.type === "remove" && (
        <BottomSheet title="Remove member" onClose={handleCloseConfirm}>
          ...
          >
            Remove{" "}
            <strong style={{ color: t.text }}>{confirm.member.name}</strong>{" "}
            from this family? They will lose access to tasks, events, and
            shopping.
          </p>
      ...
      {confirm?.type === "delete" && (
        <BottomSheet title="Delete family" onClose={handleCloseConfirm}>
          ...
          >
            This permanently deletes the family and all tasks, events, shopping
            lists, and members. Type{" "}
